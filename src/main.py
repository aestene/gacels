...
def download_data():
    from_timestamp = dt.datetime(year=2017, month=11, day=3)
    to_timestamp = dt.datetime(year=2017, month=11, day=3)
    interval = '0'
    aggregates = 'Raw'
    ...
    reg_ex_strings = ['DOW-A01-(StateRun|ActivePower|ActivePowerLimit)(U|V|W|$|A|B|C)']
